...
function Login() {
    ...
    if (ready) {
      try {
        ...
        const response = await axios.post(
          "https://api.linkagesagreements.oauife.edu.ng/api/v1/auth/login",
          formData,
          {
            headers: {
  ...
  return (
    <div
      className=" bg-grad relative h-screen w-screen 
     flex flex-col xl:flex-row "
    >
      <div className="w-full xl:w-[34vw] text-center pt-10 xl:pt-20">
        <img src="OAU_linkage.png" className="w-40 xl:w-[80%] mx-auto" />
        <h3 className="text-white font-semibold text-2xl xl:text-5xl">
          LINKAGES
        </h3>
      </div>
      <div
        className="w-full xl:w-[65vw] top-60 xl:top-0 flex flex-col justify-center align-middle
      ...
      >
        <div>
          <>
            ...
            <form
              className="mt-10 mx-auto flex flex-wrap gap-8 w-[87%] "
            ...
            >
              ...
              <div className="mt-2 w-fit mx-auto flex gap-20">
                ...
                <a
                  href="/forgotpassword"
                  className="font-semibold text-[#010080] ml-auto"
                >
                  Forgot password
                </a>
              </div>
